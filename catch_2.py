...
import matplotlib
#matplotlib.use('TkAgg') mac环境需要加入该句matplotlib: RuntimeError: Python is not installed as a framework
...
def main():
    ...
    url = "https://music.163.com/weapi/v1/resource/comments/R_SO_4_374597?csrf_token="  # 替换为你想下载的歌曲R_SO的链接
